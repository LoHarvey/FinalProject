...
It is { advance_time () } On { advance_day () }
...
== Midnight_Syndicate ==
{Name("Narrator")}{Icon("Empty_Character")}
...
The palace’s walls are fortified, its guards loyal and countless. Most of the guild has turned down the task, too afraid of being caught or even killed. Only a handful of the bravest—or most foolish—dare to step forward.
A team of four will sneak into the heart of the kingdom under the cover of the moon’s glow, strike during the busy life of the festival, and steal all that they can carry. 
...
== tonight == 
{Name("Narrator")}{Icon("Empty_Character")}{Background("Camp_Day")}Tonight, you’ll meet with the others. Together, you’ll plan, strategize, gather your materiels and rehearse your roles.
...
=== team_meeting ===
{Name("Narrator")}{Icon("Empty_Character")}{Background("Team")}
...
{Name("The King")}{Icon("King")}Next to him, The King —silent and calculating—fingers the edge of a map, his dark eyes scanning it with a sharp focus. "We’ve got a way in," he says softly, his voice carrying weight. "But it won’t be easy."

{Name("Bachita")}{Icon("Bachita")}Bachita, the fastest of the bunch, stands off to the side, her jet-black hair complimented only by her blue eyes. Her navy mask conceals her face, but the cold steel in her gaze is clear. "We don’t get second chances. Whatever we do, it has to be clean."
...
{Name("The King")}{Icon("King")}King nods, tapping his finger on the map. “We can use the confusion to our advantage. But we’ll need to move fast.”

{Name("Bachita")}{Icon("Bachita")}Bachita smiles under her mask. "I’ll be in and out before anyone even knows we’re there."

{Name("Narrator")}{Icon("Empty_Character")}The group falls quiet, each option holding its own risks. You’re in charge of the decision now.
...
{Name("The King")}{Icon("King")}King nods, tapping his finger on the map. “ Not that we will have to worry about Bachita, but we should all find some equipment so we can keep up"
...
== storage_tent ==
{Name("Narrator")}{Icon("Empty_Character")}{Background("Inventory")}The canvas flap of the Midnight Syndicate storage tent rustles as you push it open.
...
Ahead, a weapons rack catches your eye. You see a sharp dagger, its edge glinting in the lantern light. It’s well-balanced, a perfect weapon for close combat, sleek and silent, best for moving through the night.

On the opposite side, a finely crafted bow with a set of arrows rests against a rack. Its wood is smooth, and the string taut.
It would let you strike from a distance, silent and swift, but you’ll need steady hands and nerves of steel to pull it off in the heat of the moment.
Finnaly mounted to the back wall is a large crafted Axe. The stories this weapon could tell... Its about the size of you and looks to weigh about the same, a weapon made for a true warrior.

In the end, You can only have one. So choose wisely

* [Take Batchitas Dagger] -> sword_pickup
* [Take The Kings Bow]-> bow_pickup
* [Take Pipsqueaks Axe] -> axe_pickup
-> END


== sword_pickup ==

You now have Bachita's Dagger! Be wise where you swing. 
~ Items = Items + 1
~ Sword = Sword + 1 
~ Damage = Damage + 2
...
You now have The Kings Bow! Be wise where you aim. { King > 0 : The King would be proud. }
~ Items = Items + 1
~ Bow = Bow + 1 
~ Damage = Damage + 1
~ Speed = Speed + 1
...
You lug the cartoonishly large Axe and sling it to your back holster. Pipsqueak would be proud, be strong!
~ Items = Items + 1
~ Speed = Speed + 2 
...
{Name("Vera")}{Icon("Vera")}You enter the dimly lit tent, the familiar scent of smoke and leather greeting you. The leader of the Midnight Syndicate, an imposing figure known only as Vera, sits at a large wooden table, surrounded by maps and documents. 
She doesn’t look up immediately, her fingers tapping rhythmically against the surface. After a moment, her piercing gaze locks onto you, and the rest of the team shifts uneasily behind you.
...
"A risky move," she muses. "But it could work if we’re prepared. Daylight is not our friend, so you’ll need more than just a blade.
If you're planning to go in when the sun’s high, you’ll need something heavy—something that’ll give you the advantage against more guards. A dagger, or something with a bit more reach.” She stands, walking over to a nearby chest where weapons are stacked high. 
...
"But don’t forget, you’ll still need a weapon. A quick blade, something you can use in the shadows. Or a bow to avoid close combat all together"
...
== bedtime ==
{Name("Narrator")}{Icon("Empty_Character")}{Background("Camp_Site")}
...
== heist_day ==
{Name("Narrator")}{Icon("Empty_Character")}{Background("Team")}
It is the { advance_time () } On { advance_day () } the day of Moon Festival.
...
== daytime == 
{Name("Narrator")}{Icon("Empty_Character")}{Background("Camp_Day")}
The day before the heist is a blur of final preparations. You gather the team in the late afternoon, each member focused and ready.
The air is thick with anticipation, the streets bustling with the growing excitement of the Moon Festival. The city’s energy is palpable, but for you and your crew, there’s no time to indulge in the celebrations.

You head out for one last scout, moving through the alleys and shadows as the sun dips lower in the sky. The King, ever sharp-eyed, spots the last of the guards rotating their posts near the palace walls. 
Pipsqueak, standing tall and quiet as always, watches for any signs of movement, his presence a silent assurance of strength. Bachita, agile as ever, keeps an eye on the rooftops, her every movement fluid and calculated.
...
As night falls, you return to the camp, your heart pounding. The final decision has been made, the team ready.
All that’s left is to rest, for tomorrow—the heist—will begin as the moon rises.
